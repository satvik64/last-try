...
if(isset($_POST['Submit']))
{
    ...
    <?php
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre'].$MySQLi_user_table_name."` set $MySQLi_status_field='2' ";
        ...
        transfer($config,'users.php','User Banned');
        exit;
    }
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Users Ban</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="index.php">Dashboard</a></li>
                        <li class="active">Ban Users</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <div class="panel-body" style="width:70%; margin-left:15%">
                                ...
                                <div class="form-group" align="center">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        ...
                                        <input name="Submit" type="submit" class="btn btn-warning" value="Ban">
                                    </div>
                                </div>
                                <?php
